...
GraphOriginalGeneralizations <- function(givenData, originalStep) {
  ...
  #Return the graph
  return(list(graph=graph, numGeneralized=length(runsThatGeneralized)))
}
...
There were `r originalGeneralizesResults$numGeneralized` runs that generalized at step limit
`r originalStepLimit`.
